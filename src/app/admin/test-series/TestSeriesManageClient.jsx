                  ...
                  return (
                    ...
                    >
                      <div className="space-y-3">
                        ...
                        <h4 className="text-xs font-black text-slate-800 group-hover:text-indigo-650 transition truncate max-w-[240px]">
                          {pkg.title}
                        </h4>
            ...
            <div className="bg-white border border-slate-200 p-6 rounded-3xl space-y-4 shadow-sm animate-in fade-in slide-in-from-bottom-2 duration-300">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-100 pb-3">
                ...
                <button
                  ...
                  className="px-3.5 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg text-xs font-bold transition flex items-center gap-1.5 cursor-pointer shadow-sm border border-indigo-650"
                >
              ...
              <form onSubmit={handleSavePackage} className="space-y-4">
                ...
                <div className="border-t border-slate-100 pt-4 flex gap-3 justify-end select-none">
                  <button
                    type="button"
                    onClick={() => setShowAddPackageModal(false)}
                    className="px-4 py-2.5 bg-slate-50 border border-slate-200 text-slate-655 hover:bg-slate-100 rounded-xl text-xs font-bold transition cursor-pointer"
                  >
                    Cancel
                  </button>
                  <button
                    ...
                    className="px-4 py-2.5 bg-indigo-650 hover:bg-indigo-700 text-white rounded-xl text-xs font-bold transition flex items-center gap-1.5 cursor-pointer shadow-sm border border-indigo-700"
                  >
                    {isCreatingPackage ? (
